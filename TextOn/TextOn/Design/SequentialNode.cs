...
namespace TextOn.Design
{
    ...
    public class SequentialNode : INode, IEquatable<SequentialNode>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:TextOn.Design.SequentialNode"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="T:TextOn.Design.SequentialNode"/> is active.
        /// </summary>
