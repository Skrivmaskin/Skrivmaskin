...
namespace TextOn.Design
{
    ...
    public sealed class ParagraphBreakNode : INode
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:TextOn.Design.ParagraphBreakNode"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="T:TextOn.Design.ParagraphBreakNode"/> is active.
        /// </summary>
