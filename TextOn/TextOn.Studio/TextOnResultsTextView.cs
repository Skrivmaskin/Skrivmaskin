...
{
    /// <summary>
    /// TextOn results text view. A single line text view (this is to be set in the Interface Builder using "Text Field" property, but is assumed here),
    /// that supports:
    ...
    /// </summary>
    [Register (nameof (TextOnResultsTextView))]
    public class TextOnResultsTextView : NSTextView
    {
        #region Automatic properties
        #endregion

        #region Text view
        public TextOnResultsTextView (IntPtr handle) : base (handle)
        {
            this.Delegate = new TextOnResultsTextViewDelegate (this);
        }
        #endregion
