    ...
    public partial class DesignViewController : NSViewController
    {
        ...
        public override void PrepareForSegue (NSStoryboardSegue segue, NSObject sender)
        {
            ...
            case DesignViewDialogSegues.Edit:
                ...
                if (selected.modelType == DesignModelType.Text) dialog.CompiledTemplate = parent.CompiledTemplate;
                dialog.DialogAccepted += (s, e) => {
            ...
            case DesignViewDialogSegues.AddText:
                ...
                dialog.CompiledTemplate = parent.CompiledTemplate;
                dialog.DialogAccepted += (s, e) => {
        ...
        public void CreateTree ()
        {
            ...
            AddDesign (variables);
            if (this.CreateVariables (parent.Template, variables, out errorText)) {
                if (this.CreateDefinition (parent.Template.Definition, true, (d) => AddDesign (d), true, out errorText)) {
                    parent.CompiledTemplate = parent.Compiler.Compile (parent.Template);
                    loading = false;
                    return;
                }
            }
        ...
        internal bool SelectDesignNode (INode designNode)
        {
            ...
            var retVal = FindAndSelectDesignNode (designNode, parent.Template.Definition, ref indexPath);
            if (retVal) {
                TreeController.RemoveSelectionIndexPaths (TreeController.SelectionIndexPaths);
