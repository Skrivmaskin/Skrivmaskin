...
{
	class TextOnResultsTextViewDelegate : NSTextViewDelegate
	{
        internal TextOnResultsTextView TextView { get; private set;}

		public TextOnResultsTextViewDelegate (TextOnResultsTextView textView)
		{
            TextView = textView;
		}
