...
namespace Skrivmaskin.Test
{
    ...
    public static class TestProjectUtils
    {
        ...
        public static IDictionary<TestProjects, Tuple<Project, string>> SetupProjects ()
        {
            ...
            // Empty project
            var emptyProject = new Project (new List<Variable> (), new ChoiceNode ());
            var emptyExpected = "{\n  \"VariableDefinitions\": [],\n  \"Definition\": {\n    \"ChoiceName\": \"\",\n    \"Choices\": []\n  }\n}";
            ...
            var oneVariableProject = new Project (oneVariableProjectVariableDefinitions, new ChoiceNode ());
            ...
            // Paragraph break.
            var paragraphBreakProject = new Project (new List<Variable>(), new ParagraphBreakNode ());
