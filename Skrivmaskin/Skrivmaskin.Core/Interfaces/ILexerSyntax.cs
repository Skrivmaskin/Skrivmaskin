...
namespace Skrivmaskin.Core.Interfaces
{
    ...
    /// </summary>
    /// <remarks>
    /// Provided as an interface so that users may customize their tokens, however beware that customizing this will make projects unshareable obviously.
    /// All tokens are required to have length > 0.
    /// </remarks>
